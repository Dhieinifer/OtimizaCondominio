...
--
-- Table structure for table `churrasqueira`
--
...
CREATE TABLE `churrasqueira` (
  ...
  PRIMARY KEY (`cod_churrasqueira`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `churrasqueira`
--

LOCK TABLES `churrasqueira` WRITE;
/*!40000 ALTER TABLE `churrasqueira` DISABLE KEYS */;
/*!40000 ALTER TABLE `churrasqueira` ENABLE KEYS */;
UNLOCK TABLES;
